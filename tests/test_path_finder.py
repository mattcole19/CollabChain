...
def test_direct_path(mock_spotify):
    ...
    assert path.path[0][0].name == "Alpha"
    assert path.path[1][0].name == "Beta"
    assert path.path[1][1] == "Song One"
...
def test_two_hop_path(mock_spotify):
    ...
    assert path.path[0][0].name == "Alpha"
    assert path.path[1][0].name == "Gamma"
    assert path.path[2][0].name == "Delta"
    assert path.path[1][1] == "Song Two"
    assert path.path[2][1] == "Song Four"
